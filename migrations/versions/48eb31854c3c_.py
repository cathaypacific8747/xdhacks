...
Revision ID: 48eb31854c3c
Revises: 
Create Date: 2021-07-24 17:15:16.251285
...
def upgrade():
    ...
    sa.Column('destinationuserid', postgresql.UUID(as_uuid=True), nullable=True),
    sa.Column('originusername', sa.String(), nullable=True),
