...
e;window.NoGoogleBooksResultsError=f;window.ControlledError=k;window.toast=function(a){const d=a.description||"An unknown error occurred",c=`${a.headerPrefix} `||"";let h,g;switch(a.code||3){case 3:h=`${c}Error`;g="toastError";break;case 2:h=`${c}Warning`;g="toastWarning";break;case 1:h=`${c}Success`;g="toastSuccess";break;case 0:h=`${c}Information`,g="toastInformation"}M.toast({unsafeHTML:`<div>
