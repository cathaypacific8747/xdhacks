...
b;window.NoGoogleBooksResultsError=c;window.ControlledError=h;window.toast=function(a){const e=a.description||"An unknown error occurred",d=`${a.headerPrefix} `||"";let f,g;switch(a.code||3){case 3:f=`${d}Error`;g="toastError";break;case 2:f=`${d}Warning`;g="toastWarning";break;case 1:f=`${d}Success`;g="toastSuccess";break;case 0:f=`${d}Information`,g="toastInformation"}M.toast({unsafeHTML:`<div>
