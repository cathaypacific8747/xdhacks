...
function(a="An unknown error occured",b="",d=3){b=b?`${b} `:"";let h,k;switch(d){case 3:h=`${b}Error`;k="toastError";break;case 2:h=`${b}Warning`;k="toastWarning";break;case 1:h=`${b}Success`;k="toastSuccess";break;case 0:h=`${b}Information`,k="toastInformation"}M.toast({unsafeHTML:`<div>
